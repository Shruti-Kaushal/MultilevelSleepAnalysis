...
Reader could explore the relation of biofactors to sleep quality by clicking the buttons. `Sleep Quality (M)` is the metric we defined. In this project, our main concern is how different factors affected sleep quality. Here, we focus on the chemical levels. The color of the bar represent the quality of sleep, the darker blue the better sleep. And the `User ID` is arranged in descending sleep quality order in convenience of comparing different plots.
