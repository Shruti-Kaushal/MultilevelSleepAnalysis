...
ggplot(mydata, aes(mydata$user, mydata$M)) + geom_point() + scale_x_continuous(breaks = scales::pretty_breaks(n = 17)) + labs(x = "User ID", y = "Units (per minute)", title = "Sleep Quality of each User") + theme_bw()
