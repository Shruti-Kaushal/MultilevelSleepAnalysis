...
ggplot(stack(dplyr::select(mydata, c('M'))), aes(x = ind, y = values)) + geom_point() + geom_boxplot() +labs(x = "", y = "Ratio Values", title = "Distribution of Sleep Ratio and Sleep Fragmentation Index in Cohort") 
```
