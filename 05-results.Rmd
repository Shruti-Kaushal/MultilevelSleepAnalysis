...
```{r}
difference['user'] = lapply(difference['user'], function(x) as.numeric(str_remove(x,"user_")))
difference_temp <- difference[difference$user!=11,]
difference_temp <- difference_temp[order(difference_temp$user),]
