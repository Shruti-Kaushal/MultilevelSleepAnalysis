...
sleep_data %>% ggplot()+geom_point(aes(x = `In Bed Time`, y = `Efficiency`, color = 'in_bed')) + geom_point(aes(x = `Out Bed Time`, y = `Efficiency`, color = 'out_bed')) + theme_bw()
...
In this part, we will explore other possible factors that affected sleeping quality, using the metric defined above. 
