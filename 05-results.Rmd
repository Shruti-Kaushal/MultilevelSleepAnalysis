...
Heavy activity
```{r}
ggplot(df_act, aes(heavy,M)) + geom_point() + labs(title = "Sleep Quality vs Time of standing") +theme_bw()
...
ggplot(df_pos, aes(Inclinometer.Off,M)) + geom_point() + labs(title = "Sleep Quality vs Time of standing") +theme_bw()
ggplot(df_pos, aes(Inclinometer.Standing,M)) + geom_point() + labs(title = "Sleep Quality vs Time of standing") +theme_bw()
ggplot(df_pos, aes(Inclinometer.Sitting,M)) + geom_point() + labs(title = "Sleep Quality vs Time of standing") +theme_bw()
ggplot(df_pos, aes(Inclinometer.Lying,M)) + geom_point() + labs(title = "Sleep Quality vs Time of standing") +theme_bw()
```
