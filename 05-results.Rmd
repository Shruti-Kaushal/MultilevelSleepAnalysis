...
In the case that other variables are 0, we simply replace them by 1. We did not add a dummy terms as the none of the users in our cohort $TST = 0$ or $Number of Awakenings = 0$. This metric is always positive since all the variables involved are non-negative.
