...
Before we delved into the data analysis part we wanted to see how the distribution of each of the variables in the sleep.csv file. A few of the observations that we made were - 

(1) None of the users got out of the bed after getting in for the night except user 1
(2)
(3)
(4)
